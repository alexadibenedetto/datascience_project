---
title: "Final Project"
author: "Alexa DiBenedetto and Danya Murali"
date: "4/9/2018"
output:
...
dat <- read_csv("~/Grad School /Data Science/Project/guns.csv")
```
...
4. https://alexa-dibenedetto.shinyapps.io/GunDeaths/ (Link to Shiny App)
